        ...
        return(
            ...
            <div className="FAQClass">
                ...
                <section className="question">
                    <h2 className="title" >How do I know this really works?</h2>
                    <div>
                        <p>
                ...
                <section className="question">
                    <h2 className="title" >I am not sure If I can trust you with my money.</h2>
                    <div>
                        <p>
                ...
                <section className="question">
                    <h2 className="title" >What do other people think about Den of Projects?</h2>
                    <div>
                        <p>
                ...
                <section className="question">
                    <h2 className="title" >What if I don’t like it? Can I get my money back?</h2>
                    <div>
                        <p>
