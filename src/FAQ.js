...
class FAQComponent extends React.Component {
    ...
    render(){
        return(
            ...
            <div className={classes.FAQClass}>
                <img className={classes.FAQLogo} src='https://i.imgur.com/b0hbbKH.png' />
                <section className={classes.question}>
                    <h2 className={classes.title} /*onClick={this.detailVisible1}*/>How do I know this really works?</h2>
                    <div className={classes.answerWrap} /*style={{display: this.state.display1}}*/>
                ...
                <section className={classes.question}>
                    <h2 className={classes.title} /*onClick={this.detailVisible2}*/>I am not sure If I can trust you with my money.</h2>
                    <div className={classes.answerWrap} /*style={{display: this.state.display2}}*/>
                        <p className={classes.answer}>
                ...
                <section className={classes.question}>
                    <h2 className={classes.title} /*onClick={this.detailVisible3}*/>What do other people think about Den of Projects?</h2>
                    <div className={classes.answerWrap} /*style={{display: this.state.display3}}*/>
                        <p className={classes.answer}>
                ...
                <section className={classes.question}>
                    <h2 className={classes.title}>I am getting same service for very little money.</h2>
                ...
                <section className={classes.question}>
                    <h2 className={classes.title}>I worry about sharing my information online.</h2>
                    <div className={classes.answerWrap}>
                        <p className={classes.answer}>
                ...
                <section className={classes.question}>
                    <h2 className={classes.title} /*onClick={this.detailVisible4}*/>What if I don’t like it? Can I get my money back?</h2>
                    <div className={classes.answerWrap} /*style={{display: this.state.display4}}*/>
                        <p className={classes.answer}>
